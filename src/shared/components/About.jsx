        ...
        <div>
            ...
            <section className="max-w-[1400px] mx-auto 2xl:px-0 px-4 lg:py-15 py-10">
                <div className="space-y-3">
                    ...
                    <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify">With keynote sessions from renowned speakers, technical paper presentations, workshops, and panel discussions, ICCSI serves as a dynamic forum for advancing the frontiers of computer science and its real-world applications.The Selective accepted papers of our International Conference on Computer Science Innovations will be recommended to publish in the indexed Journals.</p>
                </div>
            </section>
