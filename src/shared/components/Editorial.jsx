            ...
            <div className="lg:h-90 h-70  relative bg-cover bg-center " style={{ backgroundImage: "url('/images/banner.png')" }}>
                ...
                <div className="relative z-10 flex flex-col justify-center items-center h-full space-y-2">
                    ...
                    <div className="flex space-x-2 ">
                        ...
                        <div className="flex justify-center items-center gap-1">  <span className="text-white text-xl"><HiChevronDoubleRight /> </span><h2 className=" text-[20px] poppins-medium  text-[#fcac45] ">Editorial Board</h2></div>
                    </div>
                </div>
            </div>
